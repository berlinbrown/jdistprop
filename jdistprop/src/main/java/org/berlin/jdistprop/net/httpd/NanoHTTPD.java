 ...
 *
 * <p> NanoHTTPD version 1.25, Copyright &copy; 2001,2005-2012 Jarno Elonen (elonen@iki.fi, http://iki.fi/elonen/) and Copyright &copy; 2010
 * Konstantinos Togias (info@ktogias.gr, http://ktogias.gr)
 * package org.berlin.network.httpdweb;
 */
...
public class NanoHTTPD {
    ...
    public NanoHTTPD(final int port, final File wwwroot) throws IOException {
        ...
        // Long running threwad, wait for all requests //
